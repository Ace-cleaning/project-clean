...
const features = [
  {
    ...
    description:
      'We offer top-tier cleaning and facilities maintenance services for your organization that meet and exceed industry standards.',
  ...
  },
  {
    name: 'One-Stop-Shop',
    description:
      'Your One-Stop Shop for Expert Cleaning Services. Experience the difference with a consolidated, catch-all service for all your cleaning and maintenence needs. ',
